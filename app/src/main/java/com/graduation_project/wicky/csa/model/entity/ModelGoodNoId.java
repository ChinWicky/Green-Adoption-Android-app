...
public class ModelGoodNoId {
    ...
    private String createTime ="2019-04-24T17:03:08.060Z";
    private String cycleDate="string";
    private String extJson="string";
    private int inventory;
    private String lastModified="2019-04-24T17:03:08.060Z";
    private int producerId;
    private String productName="string";
    private String productNumber="string";
    private String remark="string";
    private String sourceName="string";
    private String unit="string";
    private int unitPrice;
    private String vedioUrl="string";
