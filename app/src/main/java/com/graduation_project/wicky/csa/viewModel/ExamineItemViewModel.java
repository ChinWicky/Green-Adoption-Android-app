...
public class ExamineItemViewModel extends ItemViewModel<ExamineViewModel> {
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            if (viewModel.position == 0 || viewModel.position == 1) {
                Bundle bundle = new Bundle();
                bundle.putString("examineIn", "examine");
    ...
    public ExamineItemViewModel(@NonNull ExamineViewModel viewModel, Order entity, Good good, User suppler) {
        super(viewModel);
